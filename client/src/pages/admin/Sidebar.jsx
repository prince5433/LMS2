...
const Sidebar = () => {
  return (
    <div className="flex pt-16"> {/* Added pt-16 to account for navbar height */}
      <div className="w-[250px] sm:w-[300px] space-y-8 border-r border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-5 sticky top-16 h-[calc(100vh-64px)]l">
