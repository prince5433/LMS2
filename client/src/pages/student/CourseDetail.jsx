...
const CourseDetail = () => {
    ...
    const formattedDate = course?.createdAt ? course.createdAt.split("T")[0] : "N/A";
        ...
        <div className=' space-y-5'>
            <div className='bg-[#2D2F31] text-white'>
                <div className='max-w-7xl mx-auto py-8 px-4 md:px-8 flex flex-col gap-2'>
                    ...
                    <p>Created By{" "}<span className='text-[#C0C4FC] underline italic'>{course?.creator?.name || "Unknown"}</span></p>
