...
const HeroSection = () => {
  ...
  const searchHandler = (e) => {
    ...
    return (
        ...
        <Button onClick={()=> navigate(`/course/search?query`)}type="submit"className="bg-white dark:bg-gray-800 text-blue-600 rounded-full hover:bg-gray-200">Explore Courses</Button>
            </div>
        </div>
    )
}
