...
import { register ,login,getProfile,logout,updateProfile, enrollInCourse} from '../controllers/user.controller.js';
...
router.route("/enroll").post(isAuthenticated, enrollInCourse); // Manual enrollment for testing
